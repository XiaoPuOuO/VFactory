...
export function OpenClawGatewayConfigFields({
  ...
  return (
    <>
      ...
      {!isCreate && (
        <>
          <Field label="VFactory API URL override">
            <DraftInput
              value={
                eff(
                  "adapterConfig",
              ...
              immediate
              className={inputClass}
              placeholder="https://vfactory.example"
            />
          </Field>
          ...
          <Field label="Device auth">
            <div className="text-xs text-muted-foreground leading-relaxed">
              Always enabled for gateway agents. VFactory persists a device key during onboarding so pairing approvals
