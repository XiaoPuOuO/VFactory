...
function AnimatedToast({
  ...
  return (
    <li
      className={cn(
        "pointer-events-auto rounded-sm border shadow-xl ring-1 ring-black/10 dark:ring-white/10 transition-[transform,opacity] duration-200 ease-out",
        visible
  ...
  const content = (
    <div data-toast-viewport>
      <aside
        aria-live="polite"
        aria-atomic="false"
        className="pointer-events-none fixed bottom-4 right-4 w-full max-w-sm px-1"
      >
